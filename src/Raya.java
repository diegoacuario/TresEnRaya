...
// Metodo para presentar el jugador que tiene el turno de jugar
    ...
    public void jugar(String jugador) {
        f.visualizaDialogo(this, "Turno del jugador " + jugador, "Turno", 2000, 1);
        if (jugador.equals("Computadora")) {
            actionPerformed1("Computadora");
        }
    }
...
//Si el turno era 1 gana el jugador 1 caso contrario el jugador 2
                if (turno == 1) {
                    f.visualizaDialogo(this, "El ganador es " + nick1, "Ganador", 5000, 1);
                    f.visualizaDialogo(this, "Adiós, cuidate", "Saludo", 2000, 1);
                    ...
                    f.visualizaDialogo(this, "El ganador es " + nick2, "Ganador", 5000, 1);
                    f.visualizaDialogo(this, "Adiós, cuidate", "Saludo", 2000, 1);
                    int x = JOptionPane.showConfirmDialog(rootPane, "Desea jugar nuevamente");
                    dispose();
                    if (x == 0) {
        ...
        if (empate) {
            f.visualizaDialogo(this, "Empataron " + nick1 + " y " + nick2, "Empate", 5000, 1);
            f.visualizaDialogo(this, "Adiós, cuidate", "Saludo", 2000, 1);
            int x = JOptionPane.showConfirmDialog(rootPane, "Desea jugar nuevamente");
            dispose();
            if (x == 0) {
